...
const PendingExpertsTable: React.FC = () => {
    ...
    // Sample data with one expert
    const pendingExperts: Expert[] = [
        {
            _id: "1",
            personalInformation: {
                userName: "David Kim",
            ...
            education: [
                { degree: "MBA", institution: "IIM Ahmedabad", field: "Finance", start: 2010, end: 2012 },
            ],
            professionalDetails: {
        ...
        <>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        <h2 className="text-2xl font-semibold text-gray-800">Pending Experts</h2>
                        <p className="text-gray-500 text-sm mt-1">Review and manage expert verification requests</p>
                    </div>
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center space-x-2">
                                                <button
                                                    ...
                                                    className="inline-flex items-center px-4 py-2 bg-green-100 text-green-700 text-sm font-medium rounded-lg hover:bg-green-200 transition-all duration-200 border border-green-200"
                                                >
                                                    Approve
                                                </button>
                                                <button
                                                    onClick={() => alert("Rejected!")}
                                                    className="inline-flex items-center px-4 py-2 bg-red-100 text-red-700 text-sm font-medium rounded-lg hover:bg-red-200 transition-all duration-200 border border-red-200"
                                                >
                                                    Reject
                                                </button>
                                                <button
                                                    onClick={() => setSelectedExpert(exp)}
                                                    className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-200 transition-all duration-200 border border-blue-200"
                                                >
                                                    View
                                                </button>
                                            </div>
                ...
                <div className="mt-6 flex justify-between items-center text-sm text-gray-500">
                    <div className="flex items-center">
                        <span className="flex items-center">
                            ...
                            {filteredExperts.length} pending verification
                        </span>
                    </div>
                    <div>
                        Showing {filteredExperts.length} of {pendingExperts.length} expert{filteredExperts.length !== 1 ? 's' : ''}
                    </div>
                </div>
            </div>
                            ...
                            <div className="px-6 py-5 bg-white">
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end space-x-3">
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-red-100 text-red-700 text-sm font-medium rounded-lg hover:bg-red-200 transition-all duration-200 border border-red-200"
                                    >
                                        Reject Application
                                    </button>
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-green-100 text-green-700 text-sm font-medium rounded-lg hover:bg-green-200 transition-all duration-200 border border-green-200"
                                    >
                                        Approve Expert
                                    </button>
                                </div>
